...
class Client extends BaseXChainClient {
    ...
    getDepositTransaction(txId) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = (yield axios.get(`${this.getClientUrl().node}/thorchain/tx/${txId}`)).data;
     ...
     */
    deposit({ walletIndex = 0, asset = AssetRuneNative, amount, memo, sequence }) {
        var _a, _b, _c, _d;
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * @returns {TxHash} The transaction hash.
     */
    transfer({ walletIndex = 0, asset = AssetRuneNative, amount, recipient, memo, sequence, }) {
        var _a, _b, _c, _d;
        return __awaiter(this, void 0, void 0, function* () {
            const balances = yield this.getBalance(this.getAddress(walletIndex));
            const runeBalance = (_b = (_a = balances.filter(({ asset }) => isAssetRuneNative(asset))[0]) === null || _a === void 0 ? void 0 : _a.amount) !== null && _b !== void 0 ? _b : baseAmount(0, DECIMAL);
    ...
    getFees() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { data: { int_64_values: { NativeTransactionFee: fee }, }, } = yield axios.get(`${this.getClientUrl().node}/thorchain/constants`);
                // validate data
